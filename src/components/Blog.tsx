    ...
    <div className="min-h-screen bg-snow">
      ...
      <div className="max-w-3xl mx-auto p-4 md:p-6 pt-24 md:pt-28">
        <div className="bg-white rounded-lg shadow-lg p-6 md:p-8">
          <div className="mb-8">
            <h1 className="text-2xl md:text-3xl lg:4xl font-pt-serif font-bold text-rose mb-2">
              My Blog Posts
            </h1>
              ...
              >
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 text-pinkish transition-colors duration-300 text-sm md:text-base lg:text-lg"
                  >
                    Read on Dev.to
                  </a>
                </div>
          ...
          <div className="mt-12 text-center bg-snow rounded-lg p-6">
            ...
            <p className="text-gray-700 mb-4 text-sm md:text-base lg:text-lg">
