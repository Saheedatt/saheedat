...
const About = () => {
  return (
    <div className="min-h-screen bg-[#f8f5f5] about flex items-center justify-center p-4 pt-20 md:pt-4">
      <div className="absolute top-0 left-0 right-0 flex justify-center lg:pt-4">
        <Navigation />
      </div>

      <div className="about flex min-h-screen p-4 md:pt-4">
        <div className="max-w-3xl mx-auto p-8 bg-white rounded-lg shadow-lg">
          <div className="text-center mb-10 lg:mt-8">
            <h1 className="text-4xl font-bold text-[#880d1e] mb-2 font-pt-serif">
              About Me
            </h1>
          ...
          <div className="space-y-8">
            <p className="text-lg leading-relaxed">
              Hi, I'm{" "}
              <span className="font-semibold text-[#880d1e]">
                Saheedat Afolabi
              </span>
              ...
              <a
                ...
                className="text-[#bd3c56] hover:text-[#880d1e] transition-colors duration-300"
              >
                AltSchool Africa
              </a>
            ...
            <div className="bg-[#f8f5f5] p-6 rounded-lg border-l-2 border-[#f26a8d]">
              ...
              <div className="flex flex-wrap gap-3">
                {[
                  ...
                  <span
                    key={tech}
                    className="px-4 py-1.5 bg-white rounded-full text-sm font-medium text-[#880d1e] border border-[#f26a8d]"
                  >
                    {tech}
                  </span>
                ))}
          ...
          <div className="mt-12 pt-6 border-t border-[#f26a8d] border-opacity-30">
